...
enum armor_shapes
{
	...
	SHAPE_MAGIC_CLOAK = 403,				// Only 1 frame, red
...
enum movable_item_shapes
{
	...
	SHAPE_KEY = 641,
		...
		FRAME_OLD_KEY = 31,
	SHAPE_BOOK = 642,
		QUALITY_BEATRIX_LOVE_SONNETS = 62,
...
{
	FRAME_BROWN_DOOR = 0, 
	FRAME_BROWN_DOOR_WINDOW_H = 8,
	FRAME_BLACK_DOOR = 16,
	
	FRAME_BROWN_DOOR_V = 0,
	FRAME_DOOR_BLACK_V = 16
...
enum window_shapes
{
	SHAPE_WINDOW_WALL_H = 346,
	SHAPE_WINDOW_WALL_V = 359,
...
enum too_big_to_move
{
	...
	SHAPE_TAPESTRY_H = 849,
		...
		FRAME_SUIT_OF_ARMOR_N = 22,
		FRAME_SUIT_OF_ARMOR_S = 23,
...
enum spell_shapes
{
	...
	SHAPE_LIGHTNING_BOLT = 807,				// 8 damage, explodes!
